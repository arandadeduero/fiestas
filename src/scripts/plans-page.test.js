...
test('friendly community URLs include the share campaign', () => {
  assert.equal(
    createCommunityPlanUrl('cielo-y-estrellas', 'https://fiestas.arandadeduero.dev/plan/importar/'),
    'https://fiestas.arandadeduero.dev/planes/cielo-y-estrellas/?mtm_campaign=share'
  );
});
